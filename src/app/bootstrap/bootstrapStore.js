...
export default function() {
  ...
  const dbURL = process.env.MONGO_STRING || (process.env.MONGO_USERNAME ? `mongodb://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@${process.env.MONGO_HOST}:27017/jawn` : `mongodb://${process.env.MONGO_HOST}:27017/jawn`);
